...
class Preprocess:
    ...
    def __save_labels(self, encoder, name):
        le_path = os.path.join(self.args.asset_dir, name + "_test_classes.npy")
        np.save(le_path, encoder.classes_)

    def __preprocessing(self, df):
        cate_cols = ["KnowledgeTag"]
    ...
    def __preprocessing_test(self, df):
        ...
        for col in cate_cols:
            ...
            a = df[col].unique().tolist() + [np.nan]
            le = LabelEncoder()
            label_path = os.path.join(self.args.asset_dir, col + "_test_classes.npy")
        ...
        group = (
            ...
            .apply(
                lambda r: (
                    ...
                    r["user_test_correct_answer"].values,
                    r["user_test_total_answer"].values,
                    r["user_test_acc"].values,
                    r["user_tag_correct_answer"].values,
                    r["user_tag_total_answer"].values,
                    r["user_tag_acc"].values,
                    r["testid_first"].values,
                    r["testid_rest"].values,
                    r["itemseq"].values,
                    r["item_mean"].values,
                    r["test_mean"].values,
                    r["tag_mean"].values,
