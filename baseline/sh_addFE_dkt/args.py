...
def parse_args():
    ...
    parser.add_argument(
        "--file_name", default="df_ppd.parquet", type=str, help="train file name"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--test_file_name", default="test_ppd.parquet", type=str, help="test file name"
    )
    ...
    if args.embedding_size is None:
        args.embedding_size = args.hidden_dim
