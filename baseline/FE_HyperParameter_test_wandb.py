...
from sh_addFE_dkt.utils import get_logger, set_seeds, logging_conf
...
def main(args):
    ...
    sweep_configuration = {
        ...
        "parameters": {
            "lr": {"distribution": "uniform", "min": 0.0001, "max": 0.0005},
            "batch_size": {"values": [64, 128]},
            "n_layers": {"values": [1, 2]},
            "drop_out": {"distribution": "uniform", "min": 0.15, "max": 0.25},
            "hidden_dim": {"values": [64, 128, 256]},
            "max_seq_len": {"values": [5, 10]},
        },
    }
